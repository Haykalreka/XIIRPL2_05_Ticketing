...
namespace XIIRPL2_05_Ticketing.MasterForm
{
    public partial class FormMasterBandara : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.conn.Open();
                String sql = "INSERT INTO tbl_bandara" + "(nama,kode_iata,kota,negara_id,jumlah_terminal,alamat)" + "VALUES" + "('" + txtNama.Text + "','" + txtkodeIATA.Text + "'," + "'" + txtKota.Text + "','" + txtNegara.Text + "'," + "'" + txtJmTerminal.Text + "','" + txtAlamat.Text + "')";
